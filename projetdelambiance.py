    ...
    while True:
        ...
        with data_lock:
            if button1.is_pressed:
                ...
                buttonmaster_courant,buttonmaster=rasp_master_id, rasp_master_id
        ...
        with data_lock:
            if valeur_bouton != 0:
                try:
                    ...
                    if valeur_bouton_online != -1 and time.time()>lastupdate_online:
...
def affichagebouton9(buttonmaster, classement, lastupdate):
    ...
    try:
        ...
        draw.text((486, 10), "temps de jeu:""\n"+str(int(jeutotal/86400))+"j "+str(int(((jeutotal/86400)-math.floor(jeutotal/86400))*24))+"h "+str(int(((jeutotal/3600)-math.floor(jeutotal/3600))*60))+"min", font = font18, fill = 0)
